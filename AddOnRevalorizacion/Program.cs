...
namespace AddOnRevalorizacion
{
    class Program
    {
        static void Main(string[] args)
        {
            Conexion.Conexion_SBO oConexion = new AddOnRevalorizacion.Conexion.Conexion_SBO();
            ...
            if ((oConexion != null) && (Conexion.Conexion_SBO.m_oCompany.Connected))
            {
                ...
                Comunes.Eventos_SBO oEventos = new AddOnRevalorizacion.Comunes.Eventos_SBO();
