    ...
    class Eventos_SBO
    {
        ...
        public Eventos_SBO()
        {
            try
            {
                ...
                RegistrarMenu();
                Conexion.Conexion_SBO.m_SBO_Appl.StatusBar.SetText(AddOnRevalorizacion.Properties.Resources.NombreAddon + " Conectado con exito",
            ...
            try
            {
                switch (pVal.FormTypeEx)
                {
                    ...
                    case "Frm_AMasivas":
                        ...
                        break;
                    */
                    case Class.Frm_143.csFormType:
                        var oFrm_143 = new Class.Frm_143();
                        oFrm_143.m_SBO_Appl_ItemEvent(FormUID, ref pVal, out BubbleEvent);
                        oFrm_143 = null;
                        break;
                }
            }
                ...
                switch (pVal.BeforeAction)
                {
                    case false:
                        switch (pVal.MenuUID)
                        {
                            case "1281":
                            case "1282":
                                Class.Frm_143 oFrm_143 = null;
                                oFrm_143 = new Class.Frm_143();
                                oFrm_143.m_SBO_Appl_MenuEvent(ref pVal, out BubbleEvent);
                                oFrm_143 = null;
                                break;
                                /*
                                case "MSS_APMD":
