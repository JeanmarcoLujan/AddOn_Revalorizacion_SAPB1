...
namespace AddOnRevalorizacion.Conexion
{
    class Conexion_SBO
    {
        #region Atributos
        ...
        public Conexion_SBO()
        {
            ...
            {
                System.Windows.Forms.MessageBox.Show(AddOnRevalorizacion.Properties.Resources.NombreAddon + " Error: Conexion_SBO.cs > Conexion_SBO(): " + ex.Message, "Aceptar",
        ...
        private void ObtenerAplicacion()
        {
            try
            {
                ...
                if (strArgumentos.Length > 0)
                {
                    ...
                    else
                    {
                        ...
                        {
                            System.Windows.Forms.MessageBox.Show(AddOnRevalorizacion.Properties.Resources.NombreAddon + " Error en: Conexion_SBO.cs > ObtenerAplicacion(): SAP Business One no esta en ejecucion", "Aceptar",
            ...
            {
                {
                    System.Windows.Forms.MessageBox.Show(AddOnRevalorizacion.Properties.Resources.NombreAddon + " Error en: Conexion_SBO.cs > ObtenerAplicacion(): " + ex.Message, "Aceptar",
                    System.Windows.Forms.MessageBoxButtons.OK, System.Windows.Forms.MessageBoxIcon.Exclamation);//mensaje de error por no tener SBO activo
                }
            }
        }
        ...
        public static void ConectarCompany()
        {
                ...
                if (m_oCompany == null)
                {
                    ...
                    if (iRet == 0)
                    {
                        ...
                        if (iRet != 0)//validamos que no se hayan producido errores
                        {
                            ...
                            m_SBO_Appl.StatusBar.SetText(AddOnRevalorizacion.Properties.Resources.NombreAddon + " Error: Conexion_SBO.cs > ConectarCompany(): " + sErrMsg,
            ...
            catch (Exception ex)
            {
                m_oCompany.GetLastError(out iErrCode, out sErrMsg);//obtenemos el error que se produjo
                Comunes.FuncionesComunes.LiberarObjetoGenerico(m_oCompany);
                m_SBO_Appl.StatusBar.SetText(AddOnRevalorizacion.Properties.Resources.NombreAddon + " Error: Conexion_SBO.cs > ConectarCompany():" + ex.Message,
                    SAPbouiCOM.BoMessageTime.bmt_Short, SAPbouiCOM.BoStatusBarMessageType.smt_Error);
            }
        }
        ...
        public static void DesconectarCompany()
        {
            ...
            {
                System.Windows.Forms.MessageBox.Show("AddOnRevalorizacion.Properties.Resources.NombreAddon +  Error en: Conexion_SBO.cs > DesconectarCompany(): " + ex.Message, "Aceptar",
                    System.Windows.Forms.MessageBoxButtons.OK, System.Windows.Forms.MessageBoxIcon.Exclamation);//mensaje de error por no tener SBO activo
            }
        }
